...
curl_setopt($curlhandle, CURLOPT_URL, $upload_fullpath_short.$webservicefolder."other_gcm_server/send_message.php?regId=".$androidtoken."&mode=sendmessage&message=".urlencode($comment));		
